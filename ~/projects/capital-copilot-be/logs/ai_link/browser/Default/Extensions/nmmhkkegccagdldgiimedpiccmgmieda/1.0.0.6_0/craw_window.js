    ...
    (a
      ...
      : c !== d &&
        (void 0 === k.propertyToPolyfillSymbol[e] &&
          (k.propertyToPolyfillSymbol[e] = k.IS_SYMBOL_NATIVE ? k.global.Symbol(e) : k.POLYFILL_PREFIX + e),
        k.defineProperty(f, k.propertyToPolyfillSymbol[e], { configurable: !0, writable: !0, value: c })));
};
...
m.exportPath_ = function (a, c, d, e) {
  ...
  for (var f; a.length && (f = a.shift()); )
    ...
    else if (!d && m.isObject(c) && m.isObject(e[f])) for (var g in c) c.hasOwnProperty(g) && (e[f][g] = c[g]);
    else e[f] = c;
};
...
m.module = function (a) {
  if ('string' !== typeof a || !a || -1 == a.search(m.VALID_MODULE_RE_)) throw Error('Invalid module identifier');
  ...
  try {
    ...
    if ('string' === typeof f && f)
      (m.moduleLoaderState_.declareLegacyNamespace
        ...
        : m.SEAL_MODULE_EXPORTS && Object.seal && 'object' == typeof e && null != e && Object.seal(e),
        (m.loadedModules_[f] = { exports: e, type: m.ModuleType.GOOG, moduleId: m.moduleLoaderState_.moduleName }));
...
m.createTrustedTypesPolicy = function () {
  ...
  try {
    c = d.createPolicy(a, { createHTML: m.identity_, createScript: m.identity_, createScriptURL: m.identity_ });
  } catch (e) {
...
m.asserts.assertExists = function (a, c, d) {
  m.asserts.ENABLE_ASSERTS &&
    null == a &&
    m.asserts.doAssertFailure_('Expected to exist: %s.', [a], c, Array.prototype.slice.call(arguments, 2));
  return a;
};
m.asserts.fail = function (a, c) {
  m.asserts.ENABLE_ASSERTS &&
    m.asserts.errorHandler_(
      new m.asserts.AssertionError('Failure' + (a ? ': ' + a : ''), Array.prototype.slice.call(arguments, 1)),
    );
};
...
m.asserts.assertObjectPrototypeIsIntact = function () {
  for (var a in Object.prototype) m.asserts.fail(a + ' should not be enumerable in Object.prototype.');
};
...
var x =
  m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.map)
    ...
    : function (a, c, d) {
        for (var e = a.length, f = Array(e), g = 'string' === typeof a ? a.split('') : a, h = 0; h < e; h++)
...
m.labs.userAgent.browser.matchIE_ = function () {
  return m.labs.userAgent.util.matchUserAgent('Trident') || m.labs.userAgent.util.matchUserAgent('MSIE');
};
...
m.labs.userAgent.browser.matchFirefox_ = function () {
  return m.labs.userAgent.util.matchUserAgent('Firefox') || m.labs.userAgent.util.matchUserAgent('FxiOS');
};
...
m.labs.userAgent.browser.matchIosWebview_ = function () {
  return (
    (m.labs.userAgent.util.matchUserAgent('iPad') || m.labs.userAgent.util.matchUserAgent('iPhone')) &&
...
m.labs.userAgent.browser.matchChrome_ = function () {
  return (
    (m.labs.userAgent.util.matchUserAgent('Chrome') || m.labs.userAgent.util.matchUserAgent('CriOS')) &&
    !m.labs.userAgent.browser.matchEdgeHtml_()
  );
};
...
m.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse = function () {
  ...
  void 0 === m.html.trustedtypes.cachedPolicy_ && (m.html.trustedtypes.cachedPolicy_ = m.createTrustedTypesPolicy());
...
var Ca = function (a) {
    if (a instanceof G && a.constructor === G) return a.privateDoNotAccessOrElseSafeScriptWrappedValue_;
    (0, m.asserts.fail)("expected object of type SafeScript, got '" + a + "' of type " + m.typeOf(a));
...
m.i18n.bidi.rtlChars_ = '\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc';
...
m.i18n.bidi.ltrDirCheckRe_ = new RegExp('^[^' + m.i18n.bidi.rtlChars_ + ']*[' + m.i18n.bidi.ltrChars_ + ']');
m.i18n.bidi.rtlDirCheckRe_ = new RegExp('^[^' + m.i18n.bidi.ltrChars_ + ']*[' + m.i18n.bidi.rtlChars_ + ']');
...
m.i18n.bidi.isNeutralText = function (a, c) {
  ...
  return m.i18n.bidi.isRequiredLtrRe_.test(a) || (!m.i18n.bidi.hasAnyLtr(a) && !m.i18n.bidi.hasAnyRtl(a));
};
m.i18n.bidi.ltrExitDirCheckRe_ = new RegExp('[' + m.i18n.bidi.ltrChars_ + '][^' + m.i18n.bidi.rtlChars_ + ']*$');
m.i18n.bidi.rtlExitDirCheckRe_ = new RegExp('[' + m.i18n.bidi.rtlChars_ + '][^' + m.i18n.bidi.ltrChars_ + ']*$');
...
m.i18n.bidi.guardBracketInText = function (a, c) {
  c = (void 0 === c ? m.i18n.bidi.hasAnyRtl(a) : c) ? m.i18n.bidi.Format.RLM : m.i18n.bidi.Format.LRM;
...
m.html.TrustedResourceUrl.unwrapTrustedScriptURL = function (a) {
  ...
  m.asserts.fail("expected object of type TrustedResourceUrl, got '" + a + "' of type " + m.typeOf(a));
  return 'type_error:TrustedResourceUrl';
};
m.html.TrustedResourceUrl.format = function (a, c) {
  var d = m.string.Const.unwrap(a);
  if (!m.html.TrustedResourceUrl.BASE_URL_.test(d)) throw Error('Invalid TrustedResourceUrl format: ' + d);
...
m.html.TrustedResourceUrl.fromConstant = function (a) {
  return m.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(m.string.Const.unwrap(a));
};
  ...
  for (var e in d)
    if (Object.prototype.hasOwnProperty.call(d, e)) {
      ...
      for (var g = 0; g < f.length; g++) {
        ...
        null != h &&
          (c || (c = a),
          (c += (c.length > a.length ? '&' : '') + encodeURIComponent(e) + '=' + encodeURIComponent(String(h))));
      }
    }
  return c;
};
m.html.SafeUrl = function (a, c) {
  this.privateDoNotAccessOrElseSafeUrlWrappedValue_ = c === m.html.SafeUrl.CONSTRUCTOR_TOKEN_PRIVATE_ ? a : '';
};
...
m.html.SafeUrl.fromBlob = function (a) {
  a = m.html.SafeUrl.isSafeMimeType(a.type) ? m.fs.url.createObjectUrl(a) : m.html.SafeUrl.INNOCUOUS_STRING;
...
m.html.SafeUrl.fromFacebookMessengerUrl = function (a) {
  m.string.internal.caseInsensitiveStartsWith(a, 'fb-messenger://share') || (a = m.html.SafeUrl.INNOCUOUS_STRING);
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
m.html.SafeUrl.fromWhatsAppUrl = function (a) {
  m.string.internal.caseInsensitiveStartsWith(a, 'whatsapp://send') || (a = m.html.SafeUrl.INNOCUOUS_STRING);
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
m.html.SafeUrl.fromSmsUrl = function (a) {
  (m.string.internal.caseInsensitiveStartsWith(a, 'sms:') && m.html.SafeUrl.isSmsUrlBodyValid_(a)) ||
...
m.html.SafeUrl.fromTrustedResourceUrl = function (a) {
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(m.html.TrustedResourceUrl.unwrap(a));
};
...
m.html.SafeUrl.sanitizeAssertUnchanged = function (a, c) {
  if (a instanceof m.html.SafeUrl) return a;
  a = 'object' == typeof a && a.implementsGoogStringTypedString ? a.getTypedStringValue() : String(a);
  if (c && /^data:/i.test(a) && ((c = m.html.SafeUrl.fromDataUrl(a)), c.getTypedStringValue() == a)) return c;
...
m.html.SafeUrl.ABOUT_BLANK = m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse('about:blank');
m.html.SafeStyle = function (a, c) {
  this.privateDoNotAccessOrElseSafeStyleWrappedValue_ = c === m.html.SafeStyle.CONSTRUCTOR_TOKEN_PRIVATE_ ? a : '';
};
...
m.html.SafeStyle.fromConstant = function (a) {
  ...
  m.asserts.assert(m.string.internal.endsWith(a, ';'), "Last character of style string is not ';': " + a);
  m.asserts.assert(
...
m.html.SafeStyle.create = function (a) {
  ...
  return c ? m.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(c) : m.html.SafeStyle.EMPTY;
};
m.html.SafeStyle.sanitizePropertyValue_ = function (a) {
  ...
  a = a instanceof m.string.Const ? m.string.Const.unwrap(a) : m.html.SafeStyle.sanitizePropertyValueString_(String(a));
  if (/[{;}]/.test(a)) throw new m.asserts.AssertionError('Value does not allow [{;}], got: %s.', [a]);
  return a;
};
m.html.SafeStyle.sanitizePropertyValueString_ = function (a) {
  ...
  if (m.html.SafeStyle.VALUE_RE_.test(c)) {
    if (m.html.SafeStyle.COMMENT_RE_.test(a))
      return (m.asserts.fail('String value disallows comments, got: ' + a), m.html.SafeStyle.INNOCUOUS_STRING);
    if (!m.html.SafeStyle.hasBalancedQuotes_(a))
      return (m.asserts.fail('String value requires balanced quotes, got: ' + a), m.html.SafeStyle.INNOCUOUS_STRING);
    ...
    return (
      m.asserts.fail(
        'String value allows only ' + m.html.SafeStyle.VALUE_ALLOWED_CHARS_ + ' and simple functions, got: ' + a,
      ),
      m.html.SafeStyle.INNOCUOUS_STRING
    );
...
m.html.SafeStyle.URL_RE_ = /\b(url\([ \t\n]*)('[ -&(-\[\]-~]*'|"[ !#-\[\]-~]*"|[!#-&*-\[\]-~]*)([ \t\n]*\))/g;
...
I.unwrap = function (a) {
  if (a instanceof I && a.constructor === I) return a.privateDoNotAccessOrElseSafeStyleSheetWrappedValue_;
  (0, m.asserts.fail)("expected object of type SafeStyleSheet, got '" + a + "' of type " + m.typeOf(a));
...
m.html.SafeHtml = function (a, c, d) {
  this.privateDoNotAccessOrElseSafeHtmlWrappedValue_ = d === m.html.SafeHtml.CONSTRUCTOR_TOKEN_PRIVATE_ ? a : '';
  this.dir_ = c;
};
...
m.html.SafeHtml.htmlEscape = function (a) {
  ...
  return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    m.string.internal.htmlEscape(c && a.implementsGoogStringTypedString ? a.getTypedStringValue() : String(a)),
    d,
  );
};
...
m.html.SafeHtml.verifyTagName = function (a) {
  ...
  if (a.toUpperCase() in m.html.SafeHtml.NOT_ALLOWED_TAG_NAMES_)
    throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Tag name <' + a + '> is not allowed for SafeHtml.' : '');
};
...
m.html.SafeHtml.createSandboxIframe = function (a, c, d, e) {
  if (!m.html.SafeHtml.canUseSandboxIframe())
    throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'The browser does not support sandboxed iframes.' : '');
  var f = {};
  ...
  for (var d in c)
    if (Object.prototype.hasOwnProperty.call(c, d)) {
      ...
      if ('language' == e || 'src' == e || 'text' == e || 'type' == e)
        throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Cannot set "' + e + '" attribute' : '');
    }
  d = '';
  a = B(a);
...
m.html.SafeHtml.getAttrNameAndValue_ = function (a, c, d) {
  if (d instanceof m.string.Const) d = m.string.Const.unwrap(d);
    ...
    else throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Attribute "style" not supported.' : '');
  else {
    if (/^on/i.test(c))
      throw Error(
    ...
    f = function (g) {
      Array.isArray(g)
        ...
        : ((g = m.html.SafeHtml.htmlEscape(g)),
          ...
          (g = g.getDirection()),
          d == m.i18n.bidi.Dir.NEUTRAL ? (d = g) : g != m.i18n.bidi.Dir.NEUTRAL && d != g && (d = null));
    };
  w(c, f);
  return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(e.join(m.html.SafeHtml.unwrap(a)), d);
};
    ...
    for (var e in c)
      if (Object.prototype.hasOwnProperty.call(c, e)) {
        if (!m.html.SafeHtml.VALID_NAMES_IN_TAG_.test(e))
          throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Invalid attribute name "' + e + '".' : '');
        var f = c[e];
...
m.html.SafeHtml.BR = m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse('<br>', m.i18n.bidi.Dir.NEUTRAL);
...
m.html.uncheckedconversions.trustedResourceUrlFromStringKnownToSatisfyTypeContract = function (a, c) {
  m.asserts.assertString(m.string.Const.unwrap(a), 'must provide justification');
  m.asserts.assert(
    !m.string.internal.isEmptyOrWhitespace(m.string.Const.unwrap(a)),
    'must provide non-empty justification',
...
m.dom.safe.SET_INNER_HTML_DISALLOWED_TAGS_ = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 };
...
m.dom.safe.setInnerHtml = function (a, c) {
  if (m.asserts.ENABLE_ASSERTS && a.tagName && m.dom.safe.SET_INNER_HTML_DISALLOWED_TAGS_[a.tagName.toUpperCase()])
...
m.dom.safe.setImageSrc = function (a, c) {
  ...
  c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl.sanitizeAssertUnchanged(c, /^data:image\//i.test(c));
  a.src = m.html.SafeUrl.unwrap(c);
};
m.dom.safe.setAudioSrc = function (a, c) {
  m.dom.asserts.assertIsHTMLAudioElement(a);
  c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl.sanitizeAssertUnchanged(c, /^data:audio\//i.test(c));
  a.src = m.html.SafeUrl.unwrap(c);
};
m.dom.safe.setVideoSrc = function (a, c) {
  m.dom.asserts.assertIsHTMLVideoElement(a);
  c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl.sanitizeAssertUnchanged(c, /^data:video\//i.test(c));
  a.src = m.html.SafeUrl.unwrap(c);
};
...
m.dom.safe.openInWindow = function (a, c, d, e, f) {
  ...
  return void 0 !== e || void 0 !== f ? c.open(m.html.SafeUrl.unwrap(a), d, e, f) : c.open(m.html.SafeUrl.unwrap(a), d);
};
...
m.dom.safe.createImageFromBlob = function (a) {
  ...
  m.dom.safe.setImageSrc(
    a,
    m.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract(m.string.Const.from('Image blob URL.'), c),
  );
  return a;
};
...
m.string.numberAwareCompare_ = function (a, c, d) {
  ...
  if (!c) return 1;
  for (
    var e = a.toLowerCase().match(d), f = c.toLowerCase().match(d), g = Math.min(e.length, f.length), h = 0;
    h < g;
    h++
  ) {
    d = e[h];
...
m.string.truncateMiddle = function (a, c, d, e) {
  ...
  e && a.length > c
    ...
    : a.length > c && ((e = Math.floor(c / 2)), (a = a.substring(0, e + (c % 2)) + '...' + a.substring(a.length - e)));
  d && (a = m.string.htmlEscape(a));
  return a;
};
...
m.string.escapeChar = function (a) {
  ...
  if (a in m.string.specialEscapeChars_) return (m.string.jsEscapeCache_[a] = m.string.specialEscapeChars_[a]);
...
m.labs.userAgent.platform.isIos = function () {
  return (
    m.labs.userAgent.platform.isIphone() || m.labs.userAgent.platform.isIpad() || m.labs.userAgent.platform.isIpod()
  );
};
...
m.labs.userAgent.platform.getVersion = function () {
  ...
  m.labs.userAgent.platform.isWindows()
    ...
    : m.labs.userAgent.platform.isIos()
      ? ((c = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/), (c = (a = c.exec(a)) && a[1].replace(/_/g, '.')))
...
m.userAgent.OPERA = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_OPERA : m.labs.userAgent.browser.isOpera();
m.userAgent.IE = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_IE : m.labs.userAgent.browser.isIE();
m.userAgent.EDGE = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_EDGE : m.labs.userAgent.engine.isEdge();
m.userAgent.EDGE_OR_IE = m.userAgent.EDGE || m.userAgent.IE;
m.userAgent.GECKO = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_GECKO : m.labs.userAgent.engine.isGecko();
...
m.userAgent.MAC = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_MAC : m.labs.userAgent.platform.isMacintosh();
m.userAgent.WINDOWS = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_WINDOWS : m.labs.userAgent.platform.isWindows();
m.userAgent.isLegacyLinux_ = function () {
  return m.labs.userAgent.platform.isLinux() || m.labs.userAgent.platform.isChromeOS();
};
m.userAgent.LINUX = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_LINUX : m.userAgent.isLegacyLinux_();
...
m.userAgent.ANDROID = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_ANDROID : m.labs.userAgent.platform.isAndroid();
m.userAgent.IPHONE = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPHONE : m.labs.userAgent.platform.isIphone();
m.userAgent.IPAD = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPAD : m.labs.userAgent.platform.isIpad();
m.userAgent.IPOD = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPOD : m.labs.userAgent.platform.isIpod();
m.userAgent.IOS = m.userAgent.PLATFORM_KNOWN_
  ? m.userAgent.ASSUME_IPHONE || m.userAgent.ASSUME_IPAD || m.userAgent.ASSUME_IPOD
  : m.labs.userAgent.platform.isIos();
m.userAgent.KAIOS = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_KAIOS : m.labs.userAgent.platform.isKaiOS();
m.userAgent.determineVersion_ = function () {
  var a = '',
    c = m.userAgent.getVersionRegexResult_();
  c && (a = c ? c[1] : '');
  return m.userAgent.IE && ((c = m.userAgent.getDocumentMode_()), null != c && c > parseFloat(a)) ? String(c) : a;
};
      ...
      try {
        if (void 0 === h) d.push('undefined');
          ...
          if (f[p]) d.push('*** reference loop detected (id=' + p + ') ***');
            ...
            d.push('{');
            for (var v in h)
              if (c || 'function' !== typeof h[v]) (d.push('\n'), d.push(n), d.push(v + ' = '), g(h[v], n));
            d.push('\n' + l + '}');
            delete f[p];
          }
        } else d.push(h);
...
m.debug.exposeArray = function (a) {
  for (var c = [], d = 0; d < a.length; d++) Array.isArray(a[d]) ? c.push(m.debug.exposeArray(a[d])) : c.push(a[d]);
  return '[ ' + c.join(', ') + ' ]';
};
m.debug.normalizeErrorObject = function (a) {
  ...
  if (!(!d && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
    ...
    return { message: d, name: a.name || 'UnknownError', lineNumber: e, fileName: f, stack: c || 'Not available' };
  }
  a.stack = c;
  return a;
};
...
m.debug.enhanceError = function (a, c) {
  a instanceof Error || ((a = Error(a)), Error.captureStackTrace && Error.captureStackTrace(a, m.debug.enhanceError));
...
m.debug.entryPointRegistry.register = function (a) {
  ...
  if (m.debug.entryPointRegistry.monitorsMayExist_)
    for (var c = m.debug.entryPointRegistry.monitors_, d = 0; d < c.length; d++) a(m.bind(c[d].wrap, c[d]));
};
...
m.debug.entryPointRegistry.unmonitorAllIfPossible = function (a) {
  ...
  a = m.bind(a.unwrap, a);
  for (var d = 0; d < m.debug.entryPointRegistry.refList_.length; d++) m.debug.entryPointRegistry.refList_[d](a);
  c.length--;
};
function Fa(a) {
...
m.Disposable = function () {
  m.Disposable.MONITORING_MODE != m.Disposable.MonitoringMode.OFF && (m.Disposable.instances_[m.getUid(this)] = this);
...
m.Disposable.prototype.dispose = function () {
  if (
    !this.disposed_ &&
    ((this.disposed_ = !0), this.disposeInternal(), m.Disposable.MONITORING_MODE != m.Disposable.MonitoringMode.OFF)
  ) {
    var a = m.getUid(this);
    if (
...
m.events.BrowserFeature = {
  ...
  TOUCH_ENABLED:
    ...
    !!(m.global.document && document.documentElement && 'ontouchstart' in document.documentElement) ||
    !(!m.global.navigator || (!m.global.navigator.maxTouchPoints && !m.global.navigator.msMaxTouchPoints)),
  POINTER_EVENTS: 'PointerEvent' in m.global,
  MSPOINTER_EVENTS: 'MSPointerEvent' in m.global && !(!m.global.navigator || !m.global.navigator.msPointerEnabled),
  PASSIVE_EVENTS: (function () {
    ...
    try {
      (m.global.addEventListener('test', m.nullFunction, c), m.global.removeEventListener('test', m.nullFunction, c));
    } catch (d) {}
    return a;
  })(),
};
...
m.events.getVendorPrefixedName_ = function (a) {
  return m.userAgent.WEBKIT ? 'webkit' + a : m.userAgent.OPERA ? 'o' + a.toLowerCase() : a.toLowerCase();
};
m.events.EventType = {
  CLICK: 'click',
...
m.events.getPointerFallbackEventName_ = function (a, c, d) {
  return m.events.BrowserFeature.POINTER_EVENTS ? a : m.events.BrowserFeature.MSPOINTER_EVENTS ? c : d;
};
...
m.events.ListenerMap.prototype.remove = function (a, c, d, e) {
  ...
  return -1 < c ? (Ha(f[c]), A(f, c), 0 == f.length && (delete this.listeners[a], this.typeCount_--), !0) : !1;
};
var Ia = function (a, c) {
  var d = c.type;
...
m.events.listen_ = function (a, c, d, e, f, g) {
  ...
  if (h && !m.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    ...
    if (m.events.CAPTURE_SIMULATION_MODE == m.events.CaptureSimulationMode.OFF_AND_SILENT) return null;
  }
...
m.events.unlisten = function (a, c, d, e, f) {
  ...
  if (!a) return !1;
  if ((a = m.events.getListenerMap_(a))) if ((c = a.getListener(c, d, e, f))) return m.events.unlistenByKey(c);
  return !1;
};
...
m.events.removeAll = function (a, c) {
  ...
  for (var e in a.listeners)
    if (!c || e == c)
      for (var f = a.listeners[e].concat(), g = 0; g < f.length; ++g) m.events.unlistenByKey(f[g]) && ++d;
  return d;
};
...
m.events.getOnString_ = function (a) {
  return a in m.events.onStringMap_ ? m.events.onStringMap_[a] : (m.events.onStringMap_[a] = m.events.onString_ + a);
};
  ...
  if ((a = m.events.getListenerMap_(a)))
    if ((c = a.listeners[c.toString()]))
      for (c = c.concat(), a = 0; a < c.length; a++) {
        var g = c[a];
        g && g.capture == d && !g.removed && ((g = m.events.fireListener(g, e)), (f = f && !1 !== g));
      }
  return f;
};
...
m.events.EventHandler.prototype.listen_ = function (a, c, d, e, f) {
  Array.isArray(c) ||
    (c && (m.events.EventHandler.typeArray_[0] = c.toString()), (c = m.events.EventHandler.typeArray_));
...
m.math.longestCommonSubsequence = function (a, c, d, e) {
  ...
  for (l = 1; l <= f; l++)
    for (n = 1; n <= g; n++)
      d(a[l - 1], c[n - 1]) ? (h[l][n] = h[l - 1][n - 1] + 1) : (h[l][n] = Math.max(h[l - 1][n], h[l][n - 1]));
  var p = [];
  l = f;
  for (n = g; 0 < l && 0 < n; )
    d(a[l - 1], c[n - 1]) ? (p.unshift(e(l - 1, n - 1)), l--, n--) : h[l - 1][n] > h[l][n - 1] ? l-- : n--;
  return p;
};
...
m.iter.GroupByIterator_.prototype.next = function () {
  ...
  for (var a = (this.targetKey = this.currentKey), c = this.targetKey, d = []; this.currentKey == c; ) {
...
m.iter.slice = function (a, c, d) {
  ...
  'number' === typeof d && (m.asserts.assert(m.math.isInt(d) && d >= c), (a = m.iter.limit(a, d - c)));
  return a;
};
...
m.structs.Map.prototype.remove = function (a) {
  return m.structs.Map.hasKey_(this.map_, a)
    ? (delete this.map_[a], this.count_--, this.version_++, this.keys_.length > 2 * this.count_ && K(this), !0)
    : !1;
};
var K = function (a) {
...
b.addAll = function (a) {
  if (a instanceof m.structs.Map) for (var c = a.getKeys(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
...
b.map = function (a, c) {
  for (var d = [], e = this.head_.next; e != this.head_; e = e.next) d.push(a.call(c, e.value, e.key, this));
  return d;
};
b.some = function (a, c) {
  for (var d = this.head_.next; d != this.head_; d = d.next) if (a.call(c, d.value, d.key, this)) return !0;
  return !1;
};
b.every = function (a, c) {
  for (var d = this.head_.next; d != this.head_; d = d.next) if (!a.call(c, d.value, d.key, this)) return !1;
  return !0;
};
var La = function (a, c) {
    a.cache_
...
m.structs.clear = function (a) {
  a.clear && 'function' == typeof a.clear ? a.clear() : m.isArrayLike(a) ? ma(a) : m.object.clear(a);
};
...
m.uri.utils.splitRe_ =
  /^(?:([^:/?#.]+):)?(?:\/\/(?:([^\\/?#]*)@)?([^\\/?#]*?)(?::([0-9]+))?(?=[\\/?#]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;
m.uri.utils.ComponentIndex = { SCHEME: 1, USER_INFO: 2, DOMAIN: 3, PORT: 4, PATH: 5, QUERY_DATA: 6, FRAGMENT: 7 };
...
m.uri.utils.appendParams = function (a, c) {
  var d =
    2 == arguments.length ? m.uri.utils.buildQueryData(arguments[1], 0) : m.uri.utils.buildQueryData(arguments, 1);
...
m.uri.utils.getParamValues = function (a, c) {
  for (var d = a.search(m.uri.utils.hashOrEndRe_), e = 0, f, g = []; 0 <= (f = m.uri.utils.findParam_(a, e, c, d)); ) {
    e = a.indexOf('&', f);
    if (0 > e || e > d) e = d;
    f += c.length + 1;
...
m.Uri.prototype.toString = function () {
  ...
  if (d || 'file' == c)
    (a.push('//'),
      (c = this.getUserInfo()) && a.push(m.Uri.encodeSpecialChars_(c, m.Uri.reDisallowedInSchemeOrUserInfo_, !0), '@'),
    ...
    (this.domain_ && '/' != d.charAt(0) && a.push('/'),
      a.push(
        m.Uri.encodeSpecialChars_(
          d,
          '/' == d.charAt(0) ? m.Uri.reDisallowedInAbsolutePath_ : m.Uri.reDisallowedInRelativePath_,
          !0,
        ),
      ));
  (d = this.queryData_.toString()) && a.push('?', d);
  (d = this.getFragment()) && a.push('#', m.Uri.encodeSpecialChars_(d, m.Uri.reDisallowedInFragment_));
  return a.join('');
};
  ...
  if (m.string.contains(a, './') || m.string.contains(a, '/.')) {
    ...
    for (var d = [], e = 0; e < a.length; ) {
      ...
      '.' == f
        ? c && e == a.length && d.push('')
        : '..' == f
          ? ((1 < d.length || (1 == d.length && '' != d[0])) && d.pop(), c && e == a.length && d.push(''))
          : (d.push(f), (c = !0));
    }
    return d.join('/');
  }
...
m.Uri.encodeSpecialChars_ = function (a, c, d) {
  return 'string' === typeof a
    ? ((a = encodeURI(a).replace(c, m.Uri.encodeChar_)), d && (a = m.Uri.removeDoubleEncoding_(a)), a)
    : null;
};
...
b.getKeys = function () {
  Q(this);
  for (var a = this.keyMap_.getValues(), c = this.keyMap_.getKeys(), d = [], e = 0; e < c.length; e++)
...
b.set = function (a, c) {
  ...
  this.encodedQuery_ = null;
  a = R(this, a);
  this.containsKey(a) && (this.count_ = m.asserts.assertNumber(this.count_) - this.keyMap_.get(a).length);
...
var Ua = function (a, c, d) {
  a.remove(c);
  0 < d.length &&
    ((a.encodedQuery_ = null), a.keyMap_.set(R(a, c), C(d)), (a.count_ = m.asserts.assertNumber(a.count_) + d.length));
};
            ...
            4 == t.readyState &&
              (401 == t.status && F
                ? chrome.identity.removeCachedAuthToken({ token: F }, function () {
                    h ? Xa(a, e, d, e, f, g, !1, l, n, p) : (console.log(t), jb(t.status, t.responseText));
                  })
...
S.Environment = { PROD: 'https://www.googleapis.com', SANDBOX: 'https://www-googleapis-staging.sandbox.google.com' };
...
m.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES = !m.userAgent.IE || m.userAgent.isDocumentModeOrHigher(9);
...
m.dom.BrowserFeature.CAN_USE_PARENT_ELEMENT_PROPERTY = m.userAgent.IE || m.userAgent.OPERA || m.userAgent.WEBKIT;
...
m.dom.getDocumentHeight_ = function (a) {
  ...
  if (c) {
    ...
    if (m.dom.isCss1CompatMode_(c) && e.scrollHeight) d = e.scrollHeight != a ? e.scrollHeight : e.offsetHeight;
    else {
      c = e.scrollHeight;
...
m.dom.insertSiblingBefore = function (a, c) {
  m.asserts.assert(null != a && null != c, 'goog.dom.insertSiblingBefore expects non-null arguments');
  c.parentNode && c.parentNode.insertBefore(a, c);
};
m.dom.insertSiblingAfter = function (a, c) {
  m.asserts.assert(null != a && null != c, 'goog.dom.insertSiblingAfter expects non-null arguments');
...
m.dom.getFirstElementChild = function (a) {
  return void 0 !== a.firstElementChild ? a.firstElementChild : m.dom.getNextElementNode_(a.firstChild, !0);
};
m.dom.getLastElementChild = function (a) {
  return void 0 !== a.lastElementChild ? a.lastElementChild : m.dom.getNextElementNode_(a.lastChild, !1);
};
m.dom.getNextElementSibling = function (a) {
  return void 0 !== a.nextElementSibling ? a.nextElementSibling : m.dom.getNextElementNode_(a.nextSibling, !0);
};
...
m.dom.getTextContent_ = function (a, c, d) {
  if (!(a.nodeName in m.dom.TAGS_TO_IGNORE_))
    ...
    else if (a.nodeName in m.dom.PREDEFINED_TAG_VALUES_) c.push(m.dom.PREDEFINED_TAG_VALUES_[a.nodeName]);
  ...
  for (var e = 0, f = null; 0 < a.length && e < c; )
    if (((f = a.pop()), !(f.nodeName in m.dom.TAGS_TO_IGNORE_)))
      if (f.nodeType == m.dom.NodeType.TEXT) {
        ...
        e += g.length;
      } else if (f.nodeName in m.dom.PREDEFINED_TAG_VALUES_) e += m.dom.PREDEFINED_TAG_VALUES_[f.nodeName].length;
...
m.dom.getAncestorByTagNameAndClass = function (a, c, d, e) {
  ...
  return m.dom.getAncestor(
    a,
    function (g) {
      return (!f || g.nodeName == f) && (!d || ('string' === typeof g.className && y(g.className.split(/\s+/), d)));
    },
    !0,
    e,
  );
...
var T = function () {
  this.isFinishedLaunch_ = this.retrieveJwtFailed_ = this.transactionStarted_ = this.walletIsLoaded_ = !1;
...
m.async.nextTick = function (a, c, d) {
  ...
  'function' === typeof m.global.setImmediate && (d || m.async.nextTick.useSetImmediate_())
    ...
    : (m.async.nextTick.setImmediate_ || (m.async.nextTick.setImmediate_ = m.async.nextTick.getSetImmediateEmulator_()),
...
U.prototype.add = function (a, c) {
  ...
  d.set(a, c);
  this.workTail_ ? (this.workTail_.next = d) : ((0, m.asserts.assert)(!this.workHead_), (this.workHead_ = d));
  this.workTail_ = d;
};
...
m.async.run = function (a, c) {
  ...
  m.async.run.workQueueScheduled_ || (m.async.run.schedule_(), (m.async.run.workQueueScheduled_ = !0));
  ...
  if (null == c) d.push('null');
    ...
    if ('object' == typeof c) {
      if (Array.isArray(c)) {
        ...
        d.push('[');
        for (var f = '', g = 0; g < c; g++)
          (d.push(f), (f = e[g]), bb(a, a.replacer_ ? a.replacer_.call(e, String(g), f) : f, d), (f = ','));
        d.push(']');
        return;
      }
      if (c instanceof String || c instanceof Number || c instanceof Boolean) c = c.valueOf();
        ...
        for (e in c)
          Object.prototype.hasOwnProperty.call(c, e) &&
            ((f = c[e]),
            'function' != typeof f &&
              (d.push(g), cb(e, d), d.push(':'), bb(a, a.replacer_ ? a.replacer_.call(c, e, f) : f, d), (g = ',')));
        d.push('}');
        return;
      }
    }
...
m.json.Serializer.charsToReplace_ = /\uffff/.test('\uffff') ? /[\\"\x00-\x1f\x7f-\uffff]/g : /[\\"\x00-\x1f\x7f-\xff]/g;
var cb = function (a, c) {
  c.push(
    '"',
...
m.log.Level.createPredefinedLevelsCache_ = function () {
  ...
  for (var a = 0, c; (c = m.log.Level.PREDEFINED_LEVELS[a]); a++)
    ((m.log.Level.predefinedLevelsCache_[c.value] = c), (m.log.Level.predefinedLevelsCache_[c.name] = c));
};
...
m.log.LogBuffer.getInstance = function () {
  m.log.LogBuffer.instance_ || (m.log.LogBuffer.instance_ = new m.log.LogBuffer(m.log.LogBuffer.CAPACITY));
...
m.log.getEffectiveLevel = function (a) {
  return m.log.ENABLED && a ? V(m.log.LogRegistry.getInstance(), a.getName()).getEffectiveLevel() : m.log.Level.OFF;
};
...
m.log.publishLogRecord = function (a, c) {
  m.log.ENABLED && a && m.log.isLoggable(a, c.getLevel()) && V(m.log.LogRegistry.getInstance(), a.getName()).publish(c);
};
...
m.net.XmlHttpFactory.prototype.getOptions = function () {
  ...
  (a = this.cachedOptions_) ||
    ((a = {}),
    mb(this) &&
      ((a[m.net.XmlHttp.OptionType.USE_NULL_FUNCTION] = !0), (a[m.net.XmlHttp.OptionType.LOCAL_REQUEST_ERROR] = !0)),
...
m.net.XmlHttp.setFactory = function (a, c) {
  m.net.XmlHttp.setGlobalFactory(new m.net.WrapperXmlHttpFactory(m.asserts.assert(a), m.asserts.assert(c)));
};
...
var mb = function (a) {
  ...
  if (!a.ieProgId_ && 'undefined' == typeof XMLHttpRequest && 'undefined' != typeof ActiveXObject) {
    for (
      var c = ['MSXML2.XMLHTTP.6.0', 'MSXML2.XMLHTTP.3.0', 'MSXML2.XMLHTTP', 'Microsoft.XMLHTTP'], d = 0;
      d < c.length;
      d++
    ) {
      var e = c[d];
...
m.Promise = function (a, c) {
  ...
  m.Promise.LONG_STACK_TRACES && ((this.stack_ = []), nb(this, Error('created')), (this.currentStep_ = 0));
  if (a != m.nullFunction)
    try {
      var d = this;
      a.call(
...
var qb = function (a, c) {
  ...
  ub = function (a, c) {
    a.callbackEntries_ || (a.state_ != m.Promise.State_.FULFILLED && a.state_ != m.Promise.State_.REJECTED) || tb(a);
...
var X = function (a, c, d) {
  a.state_ == m.Promise.State_.PENDING &&
    (a === d && ((c = m.Promise.State_.REJECTED), (d = new TypeError('Promise cannot resolve to itself'))),
...
var tb = function (a) {
  ...
  rb = function (a) {
    var c = null;
    a.callbackEntries_ && ((c = a.callbackEntries_), (a.callbackEntries_ = c.next), (c.next = null));
...
m.Promise.invokeCallback_ = function (a, c, d) {
  c == m.Promise.State_.FULFILLED ? a.onFulfilled.call(a.context, d) : a.onRejected && a.onRejected.call(a.context, d);
};
var nb = function (a, c) {
...
b.start = function () {
  this.enabled = !0;
  this.timer_ ||
    ((this.timer_ = this.timerObject_.setTimeout(this.boundTick_, this.interval_)), (this.last_ = m.now()));
};
b.stop = function () {
  this.enabled = !1;
  this.timer_ && (this.timerObject_.clearTimeout(this.timer_), (this.timer_ = null));
...
m.net.XhrIo.prototype.send = function (a, c, d, e) {
  ...
  this.xhrOptions_ = this.xmlHttpFactory_ ? this.xmlHttpFactory_.getOptions() : m.net.XmlHttp.getOptions();
  ...
  try {
    (xb(this),
      0 < this.timeoutInterval_ &&
        ...
        m.log.fine(
          this.logger_,
          Y(this, 'Will abort after ' + this.timeoutInterval_ + 'ms if incomplete, xhr2 ' + this.useXhr2Timeout_),
        ),
...
var wb = function (a, c) {
  ...
  yb = function (a) {
    a.errorDispatched_ ||
      ((a.errorDispatched_ = !0), a.dispatchEvent(m.net.EventType.COMPLETE), a.dispatchEvent(m.net.EventType.ERROR));
  };
...
var Ab = function (a) {
  if (a.active_ && 'undefined' != typeof m)
    ...
    else if (a.inSend_ && Bb(a) == m.net.XmlHttp.ReadyState.COMPLETE) m.Timer.callOnce(a.onReadyStateChange_, 0, a);
    else if ((a.dispatchEvent(m.net.EventType.READY_STATE_CHANGE), Db(a))) {
      m.log.fine(a.logger_, Y(a, 'Request complete'));
      a.active_ = !1;
      try {
        if (a.isSuccess()) (a.dispatchEvent(m.net.EventType.COMPLETE), a.dispatchEvent(m.net.EventType.SUCCESS));
        else {
          try {
...
m.net.XhrIo.prototype.onProgressHandler_ = function (a, c) {
  ...
  this.dispatchEvent(
    m.net.XhrIo.buildProgressEvent_(a, c ? m.net.EventType.DOWNLOAD_PROGRESS : m.net.EventType.UPLOAD_PROGRESS),
  );
};
...
m.net.XhrIo.prototype.isSuccess = function () {
  ...
  if (!(c = m.net.HttpStatus.isSuccess(a))) {
    if ((a = 0 === a))
      ((a = m.uri.utils.getEffectiveScheme(String(this.lastUri_))), (a = !m.net.XhrIo.HTTP_SCHEME_PATTERN.test(a)));
    c = a;
  }
  return c;
};
...
m.debug.entryPointRegistry.register(function (a) {
  m.net.XhrIo.prototype.onReadyStateChangeEntryPoint_ = a(m.net.XhrIo.prototype.onReadyStateChangeEntryPoint_);
});
...
var J = function (a) {
  this.config_ = a;
  this.authenticator_ = new Z(a.getUrl(), m.bind(this.navigateToUrl_, this), m.bind(this.showOfflineWarning, this));
